...
export default function MediaCreator() {
  const [prompt, setPrompt] = useState("A dramatic church interior with golden light streaming through stained glass windows, empty pews facing an ornate altar, cinematic lighting, divine atmosphere");
  ...
  return (
    <section id="media" className="mb-16 relative z-10" data-testid="media-creator">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-300 max-w-2xl mx-auto">Generate stunning sermon backgrounds and graphics with AI</p>
        </div>
